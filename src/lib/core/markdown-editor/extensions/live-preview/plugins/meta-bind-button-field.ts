...
/**
 * ViewPlugin that manages meta-bind button decorations. Replaces
 * ```meta-bind-button``` code blocks with interactive button widgets; shows
 * raw YAML when the cursor is inside the block.
 */
export const metaBindButtonField = buildBlockField({
	name: 'meta-bind-button',

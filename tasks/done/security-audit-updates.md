...
- [x] Task 4: Force `form-data` >=4.0.6 via `overrides` in `pnpm-workspace.yaml` (todoist-sdk pins exact `4.0.5`)
- [x] Task 5: Re-run `pnpm audit`, confirm clean ("No known vulnerabilities found"), move this file to tasks/done/

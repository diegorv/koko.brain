...
- [ ] Task 2 (#122): Fix UTF-8 corruption in terminal PTY reader. Buffer incomplete trailing UTF-8 bytes between 4096-byte reads.
- [ ] Task 3 (#123): Repair `by_path` after `remove_entry` stem collision. On remove, repopulate the slot with a surviving same-stem entry if any.

...
- [x] Stage 8: Pairing + push commands wired
...
- [x] Stage 9: Wire frontend service to real Tauri backend
- [x] Stage 10: Mount plugin into settings dialog + file-explorer context menu

...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::vault::query_notes_by_property_v2,
            commands::vault::get_property_values_v2,
            commands::vault::get_note_properties_v2,
            commands::vault::update_frontmatter_v2,
            commands::vault::delete_frontmatter_key_v2,
            commands::vault::rename_frontmatter_key_v2,
